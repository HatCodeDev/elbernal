...
<div class="container inicio">
  ...
  <div class="row row-cols-1 row-cols-lg-2 mb-5">
    <div class="col text-center">
      <img src="{{ asset('images/cafe1.jpg') }}" class="img-fluid cafe3">
    </div>
    <div class="col d-flex align-items-center text-center">
      <p class="fs-4 p-1">El Bernal ofrece una experiencia única y personalizada a cada uno de nuestros clientes, brindándoles la 
  ...
  <div class="row row-cols-1 row-cols-lg-2">
    <div class="col text-center">
      <img src="{{ asset('images/cafe6.jpg') }}" class="img-fluid cafe3">
    </div>
    <div class="col d-flex align-items-center text-center">
      <p class="fs-4 p-1">Creemos que el café es más que una bebida; es una experiencia que debe ser disfrutada y personalizada. Nos esforzamos por crear un ambiente acogedor y educativo donde nuestros clientes puedan aprender sobre el proceso del café desde el grano hasta la taza.</p>
    </div>
  </div>
